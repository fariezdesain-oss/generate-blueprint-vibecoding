...
export function FilePreviewModal({ attachment, onClose }: FilePreviewModalProps) {
  ...
  return (
    ...
    >
      <div
        className="relative mx-4 flex max-h-[85vh] max-w-3xl flex-col overflow-hidden rounded-2xl border border-subtle bg-secondary shadow-2xl animate-fade-in-up"
